...
Sherratt, K., Gruson, H., Niehus, R., Grah, R., Sandman, F., Johnson, H., Prasse, B., Ullrich, A., Wolffram, D., Deuschel, J., Bosse, NI., Srivastava, A., Mingione, M., Sheldon, D., Wang, Y., Reich, NG., Gibson, G., Wattanachit, N., Ray, EL., Farcomeni, A., Lovison, G., Parolini, N., Ardenghi, G., Ziarelli, G., Tarantino, B., Giudici, P., Pribylova, L., Eclerová, V., Gogolewski, K., Gambin, A., Szczurek, E., Alaimo Di Loro, P., Villanueva, I., Català, M., Prats, C., Álvarez, E., Alonso, S., López, D., Rodloff, A., Zimmermann, T., Bartolucci, F., Pennoni, F., Baccam, P., Gurung, H., Stage, S., Suchoski, B., Barbarossa, MV., Fuhrmann, J., Hotz, T., Heyder, S., Burgard, JP., Rakowski, F., Niedzielewski, K., Semeniuk, M., Adiga, A., Hurt, B., Lewis, B., Porebski, P., Venkatramanan, S., Wang, L., Marathe, M., Bartczuk, R., Zielinski, J., Radwan, M., Nowosielski, J., Gruziel-Slomka, M., Kraus, A., Kraus, D., Dreger, F., Moszynski, A., Krupa, B., Kisielewski, J., Aznarte, JL., Pérez Álvarez, C., Reina, B., Maruotti, A., Jona Lasinio, G., Divino, F., Holger, K., Kheifetz, Y., Scholz, M., Rodiah, I., Lange, B., Bock, W., Kuhlmann, A., Mohring, J., Leithäuser, N., Wlazlo, J., Schneider, J., Mohr, S., Dehning, J., Priesemann, V., Abbott, S., Pottier, L., E. Singh, D., Guzman-Merino, M., Krymova, E., Thanou, D., Bejar, B., Sun, T., Obozinski, G., Li, ML., Dimitris, B., Saksham, S., Montero-Manso, P., Budzinski, J., Bracher, J., Funk, S.
...
We observed a contrast between a more stable performance of forecasting deaths further into the future compared to forecasts of cases. Previous work has found rapidly declining performance for case forecasts with increasing horizon [@cramerEvaluationIndividualEnsemble2021; @castroTurningPointEnd2020], while death forecasts can perform well with up to six weeks lead time [@friedmanPredictivePerformanceInternational2021]. We can similarly link this to the specific epidemic dynamics in this study. COVID-19 has a typical serial interval of less than a week [@aleneSerialIntervalIncubation2021]. This implies that case forecasts of more than two weeks only remain valid if rates of transmission and detection remain stable over the entire forecast horizon. This is unlikely to have held given the rapid changes in epidemic dynamics across many countries in Europe. Meanwhile, we can interpret the higher reliability of death forecasts as due to the longer time lag between infection and death [@jinLagDailyReported2021], and higher consistency of reporting deaths in surveillance data [@catalaRobustEstimationDiagnostic2021]. This allows forecasters to incorporate the effect of changes in transmission. Additionally, the performance of trend-based forecasts may have benefited from the slower changes to trends in incident deaths caused by gradually increasing vaccination rates.
