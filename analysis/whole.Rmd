...
Our results also suggest the limited value of reporting case forecasts further than two weeks into the future. Previous work has similarly found rapidly declining performance for case forecasts with increasing horizon [#cramer]. Covid-19 has a serial interval of less than a week, and an incubation period even shorter [#alene]. This rapid turnover of case generations means that case forecasts of over 2 weeks can only hold if rates of transmission and detection remain stable over the entire period. This stability is unlikely where viral mutations alter biological transmissibility, or behaviour change, such as that created by policy or cultural events, alter transmission chains. The performance of case forecasts in the hub likely reflected these short term influences, where performance at or beyond three weeks was similar or worse than a simple baseline forecast.
