...
```{r}
#| figure-3-alternative-ensembles,
#| fig.cap = paste0(
...
#|  (right) for one-week (top) through four-week (bottom) ahead forecasts, according to the relative weighted interval score. Boxplots show interquartile
#|  ranges, with outliers as faded points, and the ensemble model performance is marked
#|  by an asterisk."
...
```{r}
#| si-figure-alternative-ensembles,
